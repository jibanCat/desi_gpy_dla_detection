...
|---|---|---|
| preload source | `/nfs/turbo/lsa-cavestru/mfho/DESI/pscratch/desi_gpy_dla_detection/v2_runs/2lpt_loa124_nohcd_nobal_wide_v2_1778186324/trainset.h5` | `--preload` |
| n_spectra (after filter) | 203984 | post z/SNR/cap |
...
| normalize | per-spectrum median in [1310.00, 1325.00] Å rest (Garnett+2017 convention) | `--norm-min-lambda` / `--norm-max-lambda` |
...
| τ_0 | 0.004438 |
| β | 3.3149 |
| log p(D \| Adam endpoint) | 349070880.0000 |
