...
| n_spectra (after filter) | 5000 | post z/SNR/cap |
| n_pix (rest) | 5662 | preload |
| rest grid | [850.75, 1700.00] Å, dλ=0.1500 | preload |
| k (PCA components) | 30 | `--k` |
| n_iters (Adam) | 50 | `--n-iters` |
| lr | 0.005 | `--lr` |
| chunk_size (vec) | 2000 | `--chunk-size` |
| device | cuda | `--device` |
...
| τ_0 | 0.002941 |
| β | 4.3488 |
| log p(D \| Adam endpoint) | -30704142.0000 |
