...
> **STATUS: ⚠ SUPERSEDED**. pre-reorder + wide-σ collapse (β=1.28); deprecated. See 2026-05-14 `_m_normmask` post-reorder retrain when it lands.
>
