...
|---|---|---|
| preload source | `/scratch/cavestru_root/cavestru0/mfho/loa_wide_v2/loa_no_dla_no_bal_wide/trainset.h5` | `--preload` |
| n_spectra (after filter) | 637705 | post z/SNR/cap |
...
| τ_0 | 0.001890 |
| β | 3.5659 |
| log p(D \| Adam endpoint) | 2120601472.0000 |
