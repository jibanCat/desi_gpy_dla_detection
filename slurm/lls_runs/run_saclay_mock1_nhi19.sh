#!/bin/bash
# Saclay mock-1, LLS/subDLA run — NHI range 19.0–22.0
...
# DLA samples: pw_samples_a3_190_220 (NHI floor 19.0)
...
for (( START_INDEX=0; START_INDEX<=MAX_START_INDEX; START_INDEX+=STEP )); do
    ...
    echo "sbatch --export=ALL,QSOCAT=\"/global/cfs/cdirs/desicollab/mocks/lya_forest/develop/saclay/qq_desi_y3/v4.7.5/mock-1/juraLy8-124/zcat.fits\",\
MOCKDIR=\"/global/cfs/cdirs/desicollab/mocks/lya_forest/develop/saclay/qq_desi_y3/v4.7.5/mock-1/juraLy8-124/\",\
OUTDIR=\"/pscratch/sd/j/jibancat/desi-mock-saclay-1-gpdla-20260415-y3-learned-epoch920-lls_run-nhi190/\",\
...
STEP=2 slurm/submit_desi_mock.sh"
    ...
    sbatch --export=ALL,QSOCAT="/global/cfs/cdirs/desicollab/mocks/lya_forest/develop/saclay/qq_desi_y3/v4.7.5/mock-1/juraLy8-124/zcat.fits",\
MOCKDIR="/global/cfs/cdirs/desicollab/mocks/lya_forest/develop/saclay/qq_desi_y3/v4.7.5/mock-1/juraLy8-124/",\
OUTDIR="/pscratch/sd/j/jibancat/desi-mock-saclay-1-gpdla-20260415-y3-learned-epoch920-lls_run-nhi190/",\
LEARNED_FILE="/pscratch/sd/j/jibancat/desi_gpy_dla_detection/learnlogs/model_epoch_920.h5",\
DLA_SAMPLES_FILE="/pscratch/sd/j/jibancat/desi_gpy_dla_detection/data/dr12q/processed/pw_samples_a3_190_220_50000.mat",\
