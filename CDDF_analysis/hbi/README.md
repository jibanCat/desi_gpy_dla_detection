...
To **reproduce the real-LOA paper headline** (loa0 dN/dX & Ω, data-staging manifest,
provenance gate, caveats) from committed code, see **[REPRODUCE_HEADLINE.md](REPRODUCE_HEADLINE.md)**.
