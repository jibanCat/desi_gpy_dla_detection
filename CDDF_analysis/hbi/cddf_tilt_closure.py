...
def run_one_tilt(cfg: HBIConfig, cat_cut, is_TP, good_mask, truth_cut, mm,
    ...
    if estimator_fn is not estimate_f_b and isinstance(point, dict) and "_v2" in point:
        from CDDF_analysis.hbi.cddf_catalog_hbi import make_v2_refit_fn
        v2int = point["_v2"]
...
def run_wall1(cfg: HBIConfig, dalpha: float = DEFAULT_DALPHA,
    ...
    if estimator == "v2":
        import functools
        from CDDF_analysis.hbi.cddf_catalog_hbi import v2_refit
        ...
        import functools
        from CDDF_analysis.hbi.cddf_catalog_hbi import v3x_refit
